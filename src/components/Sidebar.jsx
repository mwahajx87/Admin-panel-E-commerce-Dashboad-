      ...
      >
        ...
        <div className="flex items-center justify-between h-16 px-5 border-b border-slate-800">
          <div className="flex items-center gap-3 overflow-hidden">
            <div className="w-8 h-8 bg-indigo-500 rounded-lg flex items-center justify-center text-white font-bold italic shadow-sm flex-shrink-0">
              E
            </div>
            {!isCollapsed && (
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-1.5">
                ...
                <span className="text-xs font-semibold text-slate-200">
                  {currentUser?.role === 'Admin' ? 'Admin Mode' : 'View-Only Mode'}
                </span>
              </div>
            ...
            {!isCollapsed && (
              <div className="min-w-0 flex-1 overflow-hidden">
                ...
                <div className="text-[10px] text-slate-400">
                  {currentUser?.role === 'Admin' ? 'Senior Admin' : 'Standard User'}
                </div>
              </div>
            )}
          </div>
